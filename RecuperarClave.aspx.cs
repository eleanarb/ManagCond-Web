...
namespace ManagCond
{
    public partial class RecuperarClave : System.Web.UI.Page
    {
        ...
        protected void Notificacion(string EmailDestino, string nombre, string EmailSinEncriptar)
        {
            ...
            string body = @"<h2>Recuperar contraseña</h2><p>Estimado/a,  " + nombre + ":</p><p> El " + fecha + " solicitó el restablecimiento de la contraseña de su cuenta registrada en ManagCond. Para completar el proceso, haz clic en el siguiente enlace </p><a href=" + link + "> Restablecer </a><p> Si no realizaste esta modificación o si cree que alguien ha accedido a su cuenta sin autorización, visita <a href =" + link + "> ManagCond </a> para restablecer su contraseña inmediatamente</p><p> Si necesita ayuda adicional, comunícate con Soporte técnico de ManagCond.</p><p> Atentamente,</p><p> Soporte técnico de ManagCond </p><br><div style = 'text-align: center;'><img style='width: 100px' src = 'https://managcondstorages.blob.core.windows.net/fotos/2022/12/1/logo.png?sp=r&st=2022-12-19T04:30:41Z&se=2023-03-16T12:30:41Z&spr=https&sv=2021-06-08&sr=c&sig=XBx4%2BRHL6Cu9RJzFZjQo%2BhaUYsaFImM8y00Uv9npTqg%3D' /> </div> ";
