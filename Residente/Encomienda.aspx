                            ...
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody
                                    ...
                                    <%
                                        ...
                                        foreach (Encomienda obj in EncomiendaDao.ObtenerDatosEncomienda(usuario.NumDpto.ToString(),usuario.IdCond))
                                        {
                                    %>
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3"><%if (obj.Estado.Equals("Pendiente"))
                                                                      ...
                                                                      {%><span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">Retirado</span><%}%> </td>
                                    </tr>
                                    <%
                                        }
                                    %>
