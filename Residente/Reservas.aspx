                            ...
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody
                                    ...
                                    %>
                                        ...
                                        <td class="px-4 py-3"><%if (obj.Estado == 1)
                                        ...
                                        <%if (obj.Estado == 1)
                                            { %><a href="EditarReserva.aspx?id=<%= obj.Id %>">Editar</a><%}
                                          else
                                         {%><a>No Aplica</a><%}%>
                                        </td>
                                    </tr>
                            ...
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody
                                    ...
                                    %>
                                        ...
                                        <td class="px-4 py-3"><%= obj1.Solicitante %></td>
                                        <td class="px-4 py-3"><%= obj1.EspacioComun %> </td>
                                        <td class="px-4 py-3"><%= obj1.Fecha.ToString("dd/MM/yyyy") %> </td>
                                        <td class="px-4 py-3"><%= obj1.RangoHorario %> </td>
                                        <td class="px-4 py-3"><%if (obj1.Estado == 3)
