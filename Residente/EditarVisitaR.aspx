<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarVisitaR.aspx.cs" Inherits="ManagCond.Residente.EditarVisitaR" %>
                            ...
                            <div class="grid gap-6 mb-8 md:grid-cols-2">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input datepicker datepicker-autohide datepicker-format="dd-mm-yyyy" disabled="disabled" id="inputFecha" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Seleccione fecha" runat="server" />
                                    </div>
                                </div>
                                <label class="block text-sm">
