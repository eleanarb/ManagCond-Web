                            ...
                            <li class="mb-10 ml-6">
                              ...
                              <a href="#" class="font-semibold text-purple-600 dark:text-purple-800 hover:underline"><%=obj.Nombre %></a>
                                    ...
                                    <p class="text-gray-500 dark:text-gray-300">
                                        <a class="inline-flex items-center w-full px-2 py-1 text-sm  transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="publicacionForo.aspx?id=<%=Encrypt(obj.id.ToString())%>">
