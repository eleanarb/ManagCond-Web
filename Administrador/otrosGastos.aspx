          ...
          >
            ...
            <main class="h-full overflow-y-auto">
                ...
                <div class="container grid px-6 mx-auto">
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Cargos de Noviembre</h2>
                    <div class="">                         
                    ...
                    <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                totalOtrosGastos = OtrosGastosDao.ObtenerTotalOtrosGastosCondominio(idCondominio);
                            ...
                            %>
                                ...
                                <%
                                    ...
                                    else
                                    {
                                        ...
                                        foreach (OtrosGastos obj in OtrosGastosDao.GetAlOtrosGastosCondominio(idCondominio))
                                        {
                                %>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <td class="p-4 w-4">
                                    ...
                                    <td class="py-4 px-6 md:grid-cols-2">
                                            ...
                                            <a class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" href="EditarOtroGasto.aspx?id=<%= obj.Id %>">
