                            ...
                            %>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="py-4 px-6 md:grid-cols-2">
                                            ...
                                            <a class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" href="EditarProveedor.aspx?id=<%=Encrypt(obj.Id.ToString())%>&idPago=<%=Encrypt(obj.IdPago.ToString())%>&idDireccion=<%=Encrypt(obj.IdDireccion.ToString())%>">
