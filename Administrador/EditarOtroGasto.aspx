<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarOtroGasto.aspx.cs" Inherits="ManagCond.Administrador.EditarOtroGasto" %>
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container grid px-6 mx-auto">
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Editar Cargo </h2>
                                  ...
                                  <div>
                                   ...
                                   <div class="grid gap-6 mb-8 md:grid-cols-4">
                                       <div class="col-end-7 col-span-2">
                                           <asp:Button ID="ButtonModificar" OnClientClick="return validarFormulario()" class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" runat="server" OnClick="ButtonModificar_Click" Text="Modificar" />
                                       </div>
                                   </div>
                               </form>
                    </div>
