<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Visitas.aspx.cs" Inherits="ManagCond.Guardia.Visitas" %>
     ...
     <div
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full pb-16 overflow-y-auto">
                            ...
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody
                                    ...
                                    <%
                                        ...
                                        foreach (Visita obj in VisitaDao.GetAlVisita(usuario.IdCond))
                                        {
                                    %>
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3 text-xs"><%if (obj.Estado.Equals("Pendiente")){%> <a class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" href="EditarVisita.aspx?id=<%= obj.Id %>"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg></a>                                            <button type="button" data-id="<%=obj.Id %>" data-modal-toggle="popup-modal" class="btnEliminar text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                            </button><% }else
                                                                      { %><a href="EditarVisitaR.aspx?id=<%= obj.Id %>">Editar</a><%} %>
                                        </td>
                                    </tr>
                                    <%
                                        }
                ...
                <div class="container grid px-6 mx-auto">
                    <h2
                        class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Historial de Visitas
                    </h2>
                    <!-- CTA -->
                    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
                        <div class="w-full overflow-x-auto">
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody
                                    class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <%
                                        foreach (Visita obj in VisitaDao.GetAlVisitaHistorial(usuario.IdCond))
                                        {
                                    %>
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td class="px-4 py-3"><%= obj.NumDpto %> </td>
                                        ...
                                        <%if (obj.Estado.Equals("Rechazado"))
                                            ...
                                            else{ %><span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">Aprobado</span> <%} %>
                                        </td>
                                    </tr>
                                    <%
                                        }
